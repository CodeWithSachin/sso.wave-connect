  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="rounded-xl border border-border bg-card p-6 shadow-sm">
        <h3 class="text-lg font-semibold text-foreground mb-3">SCIM 2.0 Tokens</h3>
        <p class="text-sm text-muted-foreground mb-4">
          Generate bearer tokens for enterprise IdP integration (Okta, Azure AD, Google Workspace).
        ...
        <div class="overflow-hidden rounded-lg border border-border">
          <table class="w-full text-left text-sm">
            <thead class="border-b border-border bg-muted/30">
              <tr>
                <th class="px-4 py-2 font-medium text-muted-foreground">Prefix</th>
      ...
      <div class="rounded-xl border border-border bg-card p-6 shadow-sm">
        <h3 class="text-lg font-semibold text-foreground mb-3">Sync Log</h3>
        <p class="text-sm text-muted-foreground">
          View recent SCIM provisioning and deprovisioning events from your IdP.
        </p>
      </div>
    </div>
  `,
